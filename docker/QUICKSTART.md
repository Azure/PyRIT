...
- `.env` file in PyRIT root directory with API keys
- Optionally, `.env.local` for additional environment variables
...
**.env missing**: Create `.env` file in PyRIT root with your API keys
