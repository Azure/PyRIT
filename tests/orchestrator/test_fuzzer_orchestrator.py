...
def simple_prompt_templates():
    ...
    prompt_templates = [prompt_template1.template,prompt_template2.template,prompt_template3.template,prompt_template4.template,prompt_template5.template]
...
async def test_best_UCT(simple_prompts:PromptDataset,simple_prompt_templates:list):
    ...
    UCT_scores = [0.33, 2.0,3.0,4.0,5.0]
...
async def test_select(simple_prompts: PromptDataset,probability:int,simple_prompt_templates:list):
   ...
   # prompt_template = [fuzzer_orchestrator._prompt_templates[0],fuzzer_orchestrator._prompt_templates[1]]
    ...
    new_node1._rewards = [3]
    new_node2._rewards = [4]
    new_node1.index = 0
    new_node2.index = 0
    ...
    # fuzzer_orchestrator._prompt_nodes[0]._children = [fuzzer_orchestrator._prompt_nodes[4]]
    ...
    # fuzzer_orchestrator._initial_prompts_nodes = [prompt_node[0],prompt_node[2]]
    ...
    # current = max(fuzzer_orchestrator._initial_prompts_nodes, key=fuzzer_orchestrator._best_UCT_score())
    # print('current',current.index)
    # print('child', current._children)
