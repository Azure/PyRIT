...
async def test_azure_blob_storage_io_read_file(azure_blob_storage_io):
    ...
    result = await azure_blob_storage_io.read_file("https://account.blob.core.windows.net/container/dir1/dir2/sample.png")
...
async def test_azure_blob_storage_io_write_file():
    ...
    azure_blob_storage_io = AzureBlobStorageIO(container_url=container_url, blob_content_type=SupportedContentType.PLAIN_TEXT)
    ...
    with patch.object(azure_blob_storage_io, '_create_container_client_async', return_value=None) as mock_create_client:
...
async def test_azure_storage_io_path_exists(azure_blob_storage_io):
    ...
    exists = await azure_blob_storage_io.path_exists("path")
