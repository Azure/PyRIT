...
class MemoryInterface(abc.ABC):
    ...
    def get_seeds(
        ...
        *,
        ...
        Returns:
            Sequence[Seed]: A list of prompts matching the criteria.
        """
        conditions = []
    ...
    async def add_seeds_to_memory_async(self, *, seeds: Sequence[Seed], added_by: Optional[str] = None) -> None:
        ...
        for prompt in seeds:
            ...
            serialized_prompt_value = await self._serialize_seed_value(prompt)
    ...
    def get_seed_groups(
        ...
        *,
        ...
        seed_groups = SeedDataset.group_seed_prompts_by_prompt_group_id(seed_prompts)
        return seed_groups
