...
def test_duplicate_conversation_pieces_not_score(sqlite_instance: MemoryInterface):
    ...
    assert len(sqlite_instance.get_prompt_scores(orchestrator_id=orchestrator1.get_identifier()["id"])) == 2
    assert len(sqlite_instance.get_prompt_scores(orchestrator_id=orchestrator2.get_identifier()["id"])) == 2
