...
class TestXPIAWorkflowAttackSetup:
    ...
    async def test_setup_attack_uses_request_converters(
        self, mock_attack_setup_target, mock_prompt_normalizer, mock_converter_config, basic_context, sample_attack_response
    ):
...
class TestXPIAWorkflowScoringPhase:
    ...
    @pytest.mark.asyncio
    async def test_score_response_with_scorer_returns_score(
        self, mock_attack_setup_target, mock_scorer, success_score
    ):
    ...
    async def test_score_response_handles_scorer_exception(
        self, mock_attack_setup_target, mock_scorer
    ):
    ...
    @pytest.mark.asyncio
    async def test_score_response_uses_thread_pool_executor(
        self, mock_attack_setup_target, mock_scorer, success_score
    ):
...
class TestXPIAWorkflowPerformPhase:
    ...
    async def test_perform_async_with_scorer(
        self, mock_attack_setup_target, mock_prompt_normalizer, mock_scorer, basic_context, 
        sample_attack_response, success_score
    ):
    ...
    @pytest.mark.asyncio
    async def test_perform_async_calls_methods_in_correct_order(
        self, mock_attack_setup_target, basic_context
    ):
...
class TestXPIATestWorkflowSetupPhase:
    ...
    async def test_setup_creates_processing_callback(
        self, mock_attack_setup_target, mock_processing_target, mock_scorer, mock_prompt_normalizer,
    ...
    @pytest.mark.asyncio
    async def test_setup_calls_parent_setup(
        self, mock_attack_setup_target, mock_processing_target, mock_scorer
    ):
...
class TestXPIAWorkflowIntegration:
    ...
    async def test_complete_workflow_execution_with_scorer(
        self, mock_attack_setup_target, mock_prompt_normalizer, mock_scorer,
        sample_attack_response, success_score
    ):
    ...
    async def test_test_workflow_integration(
        self, mock_attack_setup_target, mock_processing_target, mock_scorer, mock_prompt_normalizer,
        sample_attack_response, sample_processing_response, success_score
    ):
    ...
    async def test_manual_workflow_integration(
        self, mock_attack_setup_target, mock_scorer, mock_prompt_normalizer,
        sample_attack_response, success_score
    ):
