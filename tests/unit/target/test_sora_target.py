...
@pytest.mark.parametrize(
    ...
    [
        ("1080x1080", 15, 1, "n_seconds must be less than or equal to 10 for resolution dimensions of 1080x1080 or 1920x1080."),
        ("1920x1080", 5, 2, "n_variants must be less than or equal to 1 for resolution dimensions of 1080x1080 or 1920x1080."),
        ("720x720", 25, 1, "n_seconds must be less than or equal to 20 for resolution dimensions other than 1080x1080 or 1920x1080."),
        ("1280x720", 5, 3, "n_variants must be less than or equal to 2 for resolution dimensions of 720x720 or 1280x720."),
        ("480x480", 25, 1, "n_seconds must be less than or equal to 20 for resolution dimensions other than 1080x1080 or 1920x1080."),        
    ],
)
