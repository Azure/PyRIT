...
def fetch_jbb_behaviors_dataset(
    ...
    Args:
        ...
        cache (bool): Whether to cache the dataset locally. Defaults to True.
    ...
    try:
        ...
        common_metadata = {
            ...
            "description": "A dataset of harmful behaviors for jailbreaking evaluation from JailbreakBench. "
...
def fetch_jbb_behaviors_by_harm_category(harm_category: str, **kwargs) -> SeedPromptDataset:
    ...
    filtered_prompts = [
        prompt for prompt in all_dataset.prompts
