...
class ConversationManager:
    ...
    def get_last_message(self, conversation_id: str, role: Optional[str] = None) -> Optional[PromptRequestPiece]:
        """
        ...
        *,
        ...
        for piece in request.request_pieces:
            ...
            if self._process_piece_and_check_if_excluded(
                piece=piece, conversation_state=conversation_state, max_turns=max_turns, target=target
            ):
