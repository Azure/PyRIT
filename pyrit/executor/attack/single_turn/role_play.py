...
class RolePlayAttack(PromptSendingAttack):
    ...
    def _excluded_context_parameters(self) -> frozenset[str]:
        ...
        - next_message: Generated by rephrasing the objective into a role-play scenario.
        - prepended_conversation: Generated from the role-play definition (user/assistant start turns).
        """
