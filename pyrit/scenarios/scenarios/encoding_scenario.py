    ...
    def _get_converter_attacks(self) -> list[AttackRun]:
        return (
            ...
            + self._get_prompt_attacks(
                converters=[Base64Converter(encoding_func="urlsafe_b64encode")], encoding_name="Base64"
            )
            + self._get_prompt_attacks(
                converters=[Base64Converter(encoding_func="standard_b64encode")], encoding_name="Base64"
            )
            + self._get_prompt_attacks(converters=[Base64Converter(encoding_func="b2a_base64")], encoding_name="Base64")
            + self._get_prompt_attacks(converters=[Base2048Converter()], encoding_name="Base2048")
            ...
            + self._get_prompt_attacks(
                converters=[BinAsciiConverter(encoding_func="quoted-printable")], encoding_name="quoted-printable"
            )
            + self._get_prompt_attacks(
                converters=[BinAsciiConverter(encoding_func="UUencode")], encoding_name="UUencode"
            )
