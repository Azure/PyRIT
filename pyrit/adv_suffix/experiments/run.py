...
def run_trainer(
    ...
    **extra_config_parameters
    ...
    if model_name not in ["mistral", "llama_2", "llama_3", "llama_mistral"]:
...
if __name__ == '__main__':
    run_trainer(model_name = "llama_3", setup = "single", n_train_data = 2, n_steps = 10, test_steps = 1, batch_size = 128)
