...
class PromptAutomaticIterativeRefinementOrchestrator(Orchestrator):
    ...
    def _should_stop(self, *, prompt_responses: list) -> bool:
        ...
        """
        return self.stop_on_first_success and prompt_responses
    ...
    def _filter_by_orchestrator_instance_identifier(self, *, pieces: list[PromptRequestPiece]) -> list[PromptRequestPiece]:
    ...
    def print(self, *, show_successful_only: bool = True, show_orchestrator_instance_entries_only: bool = False) -> None:
        ...
        Args:
            show_successful_only (bool, optional): If set to True, only the successful jailbreaks are printed. Defaults to True.
            show_orchestrator_instance_entries_only (bool, optional): If set to True, only the entries from the current
                orchestrator instance are printed. Otherwise all the entries from the PAIR orchestrator are retrieved from
                memory, this might include runs from a previous instance. Defaults to False.
        """
