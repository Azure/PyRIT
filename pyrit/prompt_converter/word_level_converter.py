...
class WordLevelConverter(PromptConverter):
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize the WordLevelConverter with selection criteria that can be specified using indices, keywords,
        proportion, or a regex pattern. If no selection criteria are provided, all words will be converted.

        Args:
            indices: Specific indices of words to convert.
            keywords: Keywords to select words for conversion.
            proportion: Proportion of words to convert [0.0-1.0].
            regex: Regular expression pattern to match words for conversion.
        """
