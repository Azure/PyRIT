...
Ways to contribute: Check out our prompts in [seed datasets](../../pyrit/datasets/seed_datasets/local) and [jailbreak templates](../../pyrit/datasets/jailbreak); are there more you can add that include scenarios you're testing for?
