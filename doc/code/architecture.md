...
This information is often communicated through [memory](./memory/0_memory.md) which is the glue that communicates data. With memory, we can look up previous messages or custom metadata about specific components.
