...
Ways to contribute: Check out our seed prompt and jailbreak templates [here](https://github.com/Azure/PyRIT/tree/main/pyrit/datasets/); are there more you can add that include scenarios you're testing for?
