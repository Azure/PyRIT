...
message_list = [
    PromptRequestPiece(
        role="user",
        original_prompt_text="Hi, chat bot! This is my initial prompt.",
        conversation_id=conversation_id
    ),
    PromptRequestPiece(
        role="assistant",
        original_prompt_text="Nice to meet you! This is my response.",
        conversation_id=conversation_id
    ),
]
...
duckdb_memory.add_request_piece_to_memory(request_pieces=message_list)
