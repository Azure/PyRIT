...
seed_prompt_dataset = SeedPromptDataset.from_yaml_file(pathlib.Path(DATASETS_PATH) / "prompts" / "illegal.prompt")
...
# %%
prompts = azure_memory.get_seed_prompts(dataset_name="test illegal")
