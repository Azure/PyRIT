...
#
# Similarly to the [Azure OpenAI Completions](../targets/azure_completions.ipynb) endpoint, PyRIT also allows to get embeddings. The embedding response is a wrapper for the OpenAI embedding API.
