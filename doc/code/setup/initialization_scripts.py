...
initialize_pyrit(memory_db_type="InMemory", initialization_scripts=[init_script_path])
...
initialize_pyrit(memory_db_type="InMemory", initialization_scripts=[script1_path, script2_path])
...
initialize_pyrit(memory_db_type="InMemory", initialization_scripts=[real_world_path])
