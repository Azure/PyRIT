...
Prompt Targets are endpoints for where to send prompts. For example, a target could be a GPT-4 or Llama endpoint. Targets are typically used with other components like [orchestrators](../orchestrators/README.md), [scorers](../scoring/1_scoring.md), and [converters](../converters/README.md).
