...
# # Introduction
#
# This demo shows how to use PyRIT to automatically jailbreak [Gandalf](https://gandalf.lakera.ai/) using a red teaming chatbot which is deployed on an Azure OpenAI and save your results to Azure SQL Server.
#
# ## Prerequisites
#
# Before you begin, ensure the following steps have been completed:
#
# 1. Before starting this, make sure you are [set up and authenticated to use Azure OpenAI endpoints](../setup/populating_secrets.md) and [have configured an Azure SQL Server database](../setup/use_sql_server.md)
#
# 2. **Deploy an Azure OpenAI & Azure SQL Server database:** Confirm that an Azure OpenAI service and Azure SQL Server database resource is already deployed in Azure subscription.
#
...
#    - Add the SQL Server connection string (see the setup docs linked in step 1 above) to an environment variable named `AZURE_SQL_SERVER_CONNECTION_STRING`
#
