...
4. [Attacks](./code/executor/attacks/0_attack.md): These are the top-level components of PyRIT (end-to-end attack techniques). Reviewing their usage can help users understand where all components fit.
